...
void IV(){
    ...
    gStyle->SetPadGridX(true);
    gStyle->SetPadGridY(true);
    TGraphErrors* gr = new TGraphErrors("germanio.dat","%lg %lg %lg %lg");
    ...
    pad2->SetGridy();
    pad2->SetLogy();
    TGraphErrors* grl = new TGraphErrors("germanio.dat","%lg %lg %lg %lg");
    ...
    std::fstream in;
    in.open("germanio.txt",std::fstream::out);
